  ...
  return (
    <AuroraBackground>
      ...
      <div className="relative flex flex-col gap-4 items-center justify-center px-4 pt-20">
        <h1 className="text-5xl md:text-6xl font-bold text-black mb-6 text-center animate-fade-in-up">
          Smart App Name
        </h1>
        <p className="text-xl md:text-2xl text-black/90 mb-10 max-w-3xl mx-auto text-center animate-fade-in-up animation-delay-200">
